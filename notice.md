...
### 튜브렌즈 v6.4.2 업데이트!
- 인스톨 버전
  : 기존 단일 exe버전보다 첫로딩이 빨라집니다.
- 챗봇 기능 개선
  : 챗봇 기능이 더욱 편해졌습니다.

### 틱톡렌즈 v2.2 업데이트!
✅ 인스타그램 지원 추가!
홈페이지 다운로드 페이지에서 새로 받아서 설치해주세요 :)

틱톡 + 도우인 + 인스타그램
세 플랫폼을 하나의 확장앱으로!

- 틱톡
영상 위에 조회수/좋아요/댓글/북마크/공유/날짜 한눈에 표시
원클릭 다운로드
- 인스타그램 (NEW!)
릴스 그리드 & 피드에서 조회수/좋아요/댓글/날짜 실시간 표시
릴스 영상 최고화질 다운로드
- 도우인 (틱톡 중국판)
워터마크 없는 원본 영상 다운로드

💡 사용법: 크롬/웨일 브라우저에서 설치 후, 튜브렌즈 인증키 입력하면 바로 사용!
영상 하나하나 클릭해서 확인할 필요 없이, 피드만 스크롤해도 모든 정보가 보입니다 
...
### 🎧튜브 TTS! v6.3.5 업데이트
- 미리듣기 / 속도조정 / 볼륨조절 추가
: 플러스TTS는 1500자 내로 사용하시는게 퀄리티가 좋습니다 :)
- 튜브 TTS = 베이직 TTS + 플러스 TTS
- GEMINI 기반 고퀄 TTS 추가
- 무료 GEMINI API 사용시, 하루 10번 사용가능
: 미리 Gemini API를 여러개 등록해서 사용하시거나, 유료 API를 이용하시면 편리합니다.(1분/약28원)
---
